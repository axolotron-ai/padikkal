    ...
    <div className="w-full max-w-3xl min-w-[400px] rounded-xl overflow-hidden bg-white">
      ...
      <div className="relative bg-gray-200 aspect-video">
        {!isPlaying ? (
          <>
            {/* Poster Image */}
            <img src={posterImage || "/placeholder.svg"} alt="Video thumbnail" className="w-full h-full object-cover" />
          ...
          <video className="w-full h-full" controls autoPlay poster={posterImage}>
        ...
        <div className="flex space-x-1">
          {Array.from({ length: 5 }).map((_, i) => (
            <svg
              ...
              className={`w-4 h-4 lg:w-6 lg:h-6 ${i < rating ? "text-amber-400 drop-shadow-md" : "text-gray-300"}`}
            >
              <path
                strokeLinecap="round"
